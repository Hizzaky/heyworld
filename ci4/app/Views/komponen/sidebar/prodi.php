    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown <?= $var=isset($sideTaxbloom)? 'active':'' ?>">
                ...
                <ul class="dropdown-menu">
                    <li class="<?= $var = isset($menuIndexKataKerja) ? 'active' : '' ?>"><a class="nav-link" href="/Prodi/Kata-kerja">Index Kata Kerja</a></li>
                    <li class="<?= $var = isset($menuAddKataKerja) ? 'active' : '' ?>"><a class="nav-link" href="/Prodi/Penambahan-kata-kerja">Penambahan Kata Kerja</a></li>
                    <li class="<?= $var = isset($menuDelKataKerja) ? 'active' : '' ?>"><a class="nav-link" href="/Prodi/Restore-kata-kerja">Kata Kerja Terhapus</a></li>

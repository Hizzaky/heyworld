            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown form-inline">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/login?l=dosen">Sebagai Dosen</a>
                            <a class="dropdown-item" href="/login?l=prodi">Sebagai Prodi</a>
                            <a class="dropdown-item" href="/login?l=fakultas">Sebagai Fakultas</a>
                        </div>
                        <!-- <div class="dropdown-menu" aria-labelledby="navbarDropdown">

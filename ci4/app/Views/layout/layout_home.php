            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown form-inline">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/dosen">Sebagai Dosen</a>
                            <a class="dropdown-item" href="/prodi">Sebagai Prodi</a>
                            <a class="dropdown-item" href="/fakultas">Sebagai Fakultas</a>
                        </div>
                        <!-- <div class="dropdown-menu" aria-labelledby="navbarDropdown">
